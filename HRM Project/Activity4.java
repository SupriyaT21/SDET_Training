...
public class Activity4 {
  ...
  public void f() {
	  ...
	  driver.findElement(By.id("lastName")).sendKeys("Tundalwar");
	...
	// creating an instance of Random class
	  ...
	  driver.findElement(By.id("user_name")).sendKeys("Supriya Tundalwar"+int1);
	  ...
	  driver.findElement(By.id("searchSystemUser_userName")).sendKeys("Supriya Tundalwar"+int1);
	...
	//Validate that the Employee profile has been added 
	  ...
	  String expected="Supriya Tundalwar";
